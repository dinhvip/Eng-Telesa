...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Info card */}
      <div className="bg-blue-50/70 border border-blue-200/60 rounded-xl px-5 py-4">
        <div className="flex gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-blue-800">Mock data mode</p>
            <p className="text-xs text-blue-600 mt-0.5">
              Changes are stored in local state only and will be lost on refresh.
              Connect to your backend API to persist settings.
            </p>
          </div>
        </div>
      </div>
